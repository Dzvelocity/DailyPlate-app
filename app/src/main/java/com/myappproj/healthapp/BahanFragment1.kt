...
class BahanFragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        textBahan1.setOnClickListener {
            // Navigasi ke fragmen sebelumnya saat tombol diklik
    ...
    private fun fetchDataFromFirebase() {
        // Membuat query untuk mengambil data bahan yang memiliki jenis 'sehat'
        val query = database.orderByChild("jenis").equalTo("sehat")
