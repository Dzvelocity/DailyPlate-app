...
class MyMenuView : RecyclerView.Adapter<MyMenuView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.jmlKaloriTextView.text = currentMenu.calorieContent
        holder.tagMenuTextView.text = currentMenu.menuType

        holder.itemView.setOnClickListener {
            it.findNavController().navigate(R.id.action_homeFragment_to_mainResepFragment)
        }
    }
